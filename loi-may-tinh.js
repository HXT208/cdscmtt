const pcErrors = [
    ...
    },
    {
        ...
        keywords: [
            "ram khác bus cắm chung pc",
            "xmp không bật được do ram lệch",
            "ram 3200 và 2666 chạy chung",
            "mainboard hạ bus theo thanh thấp",
            "blue screen do ram không đồng bộ",
            "test memtest86 ram xung đột",
            "mua ram cùng hãng cùng bus tránh lỗi",
        ],
    ...
    },
    {
        ...
        keywords: [
            "máy tính bật lên rồi tắt", 
            "pc kích nguồn tắt liền", 
            "lỗi short circuit pc", 
            "ngắn mạch mainboard"
        ],
    ...
    },
    {
        ...
        keywords: [
            ...
            "screen tearing sửa lỗi", 
            "bật v-sync chống xé hình", 
            "màn hình bị sọc ngang khi di chuyển"
        ],
